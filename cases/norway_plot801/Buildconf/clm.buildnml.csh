...
if ($ATM_GRID != $OCN_GRID) then
  set CLM_BLDNML_OPTS = "$CLM_BLDNML_OPTS -mask $OCN_GRID"
endif
...
#     set clm_startfile = "P1850CLM4.5BGCDV_STAGE1.clm2.r.0001-01-06-00000.nc"
...
#      set clm_startfile = "-clm_startfile P1850CLM4.5BGCDV_STAGE1.clm2.r.0001-01-06-00000.nc"
    endif
endif
