...
!#### Hui
    allocate(pdgvs%tmin_5(beg:end))
    allocate(pdgvs%tda_5d(beg:end))
    allocate(pdgvs%tmin_5_inst(beg:end))
    allocate(pdgvs%preci01(beg:end))
    allocate(pdgvs%preci02(beg:end))
    allocate(pdgvs%preci03(beg:end))
    allocate(pdgvs%preci04(beg:end))
    allocate(pdgvs%preci05(beg:end))
    allocate(pdgvs%preci06(beg:end))
    allocate(pdgvs%preci07(beg:end))
    allocate(pdgvs%preci08(beg:end))
    allocate(pdgvs%preci09(beg:end))
    allocate(pdgvs%preci10(beg:end))
    allocate(pdgvs%preci11(beg:end))
    allocate(pdgvs%preci12(beg:end))
    allocate(pdgvs%swe_10(beg:end))
!#### Hui
...
!#### Hui
    pdgvs%tmin_5(beg:end)           = nan
    pdgvs%tda_5d(beg:end)           = nan
    pdgvs%tmin_5_inst(beg:end)           = nan
    pdgvs%preci01(beg:end)           = nan
    pdgvs%preci02(beg:end)           = nan
    pdgvs%preci03(beg:end)           = nan
    pdgvs%preci04(beg:end)           = nan
    pdgvs%preci05(beg:end)           = nan
    pdgvs%preci06(beg:end)           = nan
    pdgvs%preci07(beg:end)           = nan
    pdgvs%preci08(beg:end)           = nan
    pdgvs%preci09(beg:end)           = nan
    pdgvs%preci10(beg:end)           = nan
    pdgvs%preci11(beg:end)           = nan
    pdgvs%preci12(beg:end)           = nan
    pdgvs%swe_10(beg:end)           = nan
!#### Hui
...
!#### Hui
    allocate(gps%tmin_5_20(beg:end))
    allocate(gps%swe_10_20(beg:end))
    allocate(gps%bioclim15_20(beg:end))
!#### Hui
...
!#### Hui
    gps%tmin_5_20(beg:end) = nan
    gps%swe_10_20(beg:end) = nan
    gps%bioclim15_20(beg:end) = nan
!#### Hui
