...
do
    ...
    set ${CASE}.micom${inst_suffix}.r.*;              latest=`ls -rt $* 2> /dev/null | tail -1`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/ocn/rest $*
    set ${CASE}.micom${inst_suffix}.rbgc.*;           latest=`ls -rt $* 2> /dev/null | tail -1`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/ocn/rest $*
    set ${CASE}.micom${inst_suffix}.h*;                                                                                                        dispose ifiles_n ${sta}/ocn/hist $*
    IDX=`expr $IDX + 1`
done
